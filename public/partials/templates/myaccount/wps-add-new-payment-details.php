...
<form id="order_review" method="post" class="wps_add_pay_form">
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><?php esc_html_e( 'Product', 'subscriptions-for-tradingview' ); ?></th>
				<th class="product-quantity"><?php esc_html_e( 'Quantity', 'subscriptions-for-tradingview' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'subscriptions-for-tradingview' ); ?></th>
			</tr>
		</thead>
		<tfoot>
	...
	<div id="payment">
		<?php
		$button_text = __( 'Add payment method', 'subscriptions-for-tradingview' );
		...
		if ( $available_gateways ) {
			...
			<ul class="payment_methods methods wps_payment_method">
				...
				foreach ( $available_gateways as $key => $gateway ) :
					...
					$wps_payment_method = apply_filters( 'wps_tdv_supported_add_payment_gateway', $wps_supported_method, $key );
				...
				<?php endforeach; ?>
						...
						<div class="form-row wps_tdv_from_row">
			<?php wp_nonce_field( 'wps_tdv__change_payment_method', '_wps_tdv_nonce', true, true ); ?>
