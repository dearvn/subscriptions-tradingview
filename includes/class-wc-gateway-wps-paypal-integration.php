 ...
 * @subpackage Subscriptions_For_TradingView/package/wps-build-in-paypal
 */
...
class WC_Gateway_Wps_Paypal_Integration extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title       = __( 'TradingView Paypal Payment', 'wps-paypal-integration-for-woocommerce' );
	...
	public function init_form_fields() {
		$this->form_fields = include SUBSCRIPTIONS_FOR_TRADINGVIEW_DIR_PATH . 'package/gateways/wps-paypal/wps-paypal-gateway-fields.php';
	}
