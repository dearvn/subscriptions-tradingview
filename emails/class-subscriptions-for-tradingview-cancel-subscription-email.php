...
if ( ! class_exists( 'Subscriptions_For_TradingView_Cancel_Subscription_Email' ) ) {
	 ...
	 * @subpackage Subscriptions_For_TradingView/email
	 */
	class Subscriptions_For_TradingView_Cancel_Subscription_Email extends WC_Email {
		/**
		...
		public function __construct() {
			...
			$this->id          = 'wps_tdv_cancel_subscription';
			$this->title       = __( 'Cancelled Subscription Email Notification', 'subscriptions-for-tradingview' );

			$this->description = __( 'This Email Notification Send if any subscription is Cancelled', 'subscriptions-for-tradingview' );

			$this->template_html  = 'wps-tdv-cancel-subscription-email-template.php';
			$this->template_plain = 'plain/wps-tdv-cancel-subscription-email-template.php';
		...
		public function get_default_subject() {
			return __( 'Cancelled Susbcription Email {site_title}', 'subscriptions-for-tradingview' );
		}
		...
		public function get_default_heading() {
			return __( 'Subscription Cancelled', 'subscriptions-for-tradingview' );
		}
...
return new Subscriptions_For_TradingView_Cancel_Subscription_Email();
