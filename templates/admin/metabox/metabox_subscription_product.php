...
<div id="woocommerce-order-items">
	<div class="woocommerce_order_items_wrapper wc-order-items-editable">
		<table cellpadding="0" cellspacing="0" class="woocommerce_order_items tws_subscription_items_list">
			<thead>
			<tr>
				<th class="tws_subscription_items_list_item"
					colspan="2"><?php esc_html_e( 'Item', 'tdv-woocommerce-subscription' ); ?></th>
				<th class="tws_subscription_items_list_quantity"><?php esc_html_e( 'Cost', 'tdv-woocommerce-subscription' ); ?></th>
				<th class="tws_subscription_items_list_quantity"><?php esc_html_e( 'Qty', 'tdv-woocommerce-subscription' ); ?></th>
				<th class="tws_subscription_items_list_total"><?php esc_html_e( 'Total', 'tdv-woocommerce-subscription' ); ?></th>
				<th class="tws_subscription_items_list_tax"><?php esc_html_e( 'Tax', 'tdv-woocommerce-subscription' ); ?></th>
			...
			<tr class="item">
				...
				<td class="name tws_subscription_items_list_item">
					<?php
					...
					if ( $product && $product->get_sku() ) {
						echo '<div class="wc-order-item-sku"><strong>' . esc_html__( 'SKU:', 'tdv-woocommerce-subscription' ) . '</strong> ' . esc_html( $product->get_sku() ) . '</div>';
					}

					if ( $subscription->variation_id ) {
						echo '<div class="wc-order-item-variation"><strong>' . esc_html__( 'Variation ID:', 'tdv-woocommerce-subscription' ) . '</strong> ';
						if ( 'product_variation' === get_post_type( $subscription->variation_id ) ) {
							echo esc_html( $subscription->variation_id ) . '<br>';
							tdv_tws_get_product_meta( $subscription, $subscription->variation );
						} else {
							/* translators: %s: variation id */
							printf( esc_html_x( '%s (No longer exists)', 'Placeholder: variation id', 'tdv-woocommerce-subscription' ), esc_html( $subscription->variation_id ) );
						}
						echo '</div>';
					}
					?>
				...
				<td class="tws_subscription_items_list_cost item_cost" width="1%">
					<div class="view">
						<?php
				...
				<td class="line_cost tws_subscription_items_list_total" width="1%">
					...
					<div class="edit" style="display: none;">
						<div class="split-input">
							<div class="input">
								<label><?php esc_attr_e( 'Total:', 'tdv-woocommerce-subscription' ); ?></label>
								<input type="text" name="tws_line_total"
				...
				<td class="line_cost tws_subscription_items_list_total" width="1%">
					...
					<div class="edit" style="display: none;">
						<div class="split-input">
							<div class="input">
								<label><?php esc_attr_e( 'Total Tax:', 'tdv-woocommerce-subscription' ); ?></label>
								<input type="text" name="tws_line_tax"
									placeholder="<?php echo esc_attr( wc_format_localized_price( 0 ) ); ?>"
					...
					<div class="wc-order-edit-line-item-actions">
						<?php if ( $subscription->can_be_editable( 'recurring_amount' ) ) : ?>
							<a class="edit-order-item tips" href="#"
								data-tip="<?php esc_attr_e( 'Edit item', 'tdv-woocommerce-subscription' ); ?>"></a>
						<?php endif; ?>
					</div>
				</td>
			</tr>
			...
			<?php if ( ! empty( $subscription->subscriptions_shippings ) ) : ?>
				<tr class="shipping">
						...
						<td class="name">
							...
							<div class="edit" style="display: none;">
								<input type="text" class="shipping_method_name"
									placeholder="<?php esc_attr_e( 'Shipping name', 'tdv-woocommerce-subscription' ); ?>"
									name="tws_shipping_method_name"
					...
					<td class="line_cost" width="1%">
						...
						<div class="edit" style="display: none;">
							<input type="text" name="tws_shipping_cost_line_cost"
								placeholder="<?php echo esc_attr( wc_format_localized_price( 0 ) ); ?>"
					...
					<td class="line_tax" width="1%">
						...
						<div class="edit" style="display: none;">
							<input type="text" name="tws_shipping_cost_line_tax"
								placeholder="<?php echo esc_attr( wc_format_localized_price( 0 ) ); ?>"
	...
	<div class="wc-order-data-row wc-order-totals-items wc-order-items-editable">
		...
		if ( $coupons ) :
			...
			<div class="wc-used-coupons">
				<ul class="wc_coupon_list">
					<li><strong><?php esc_html_e( 'Coupon(s)', 'tdv-woocommerce-subscription' ); ?></strong></li>
					<?php
		...
		<table class="wc-order-totals">
			<?php if ( $subscription->subscriptions_shippings ) : ?>
				<tr>
					<td class="label"><?php esc_html_e( 'Shipping', 'tdv-woocommerce-subscription' ); ?>:</td>
					<td width="1%"></td>
					<td class="total">
						<?php
			...
			<?php if ( wc_tax_enabled() ) : ?>
				...
				<tr>
					<td class="label"><?php esc_html_e( 'Tax', 'tdv-woocommerce-subscription' ); ?>:</td>
					<td width="1%"></td>
					<td class="total">
						<?php
			...
			<tr>
				<td class="label"><?php esc_html_e( 'Total', 'tdv-woocommerce-subscription' ); ?>:</td>
				<td width="1%"></td>
				<td class="total">
					<?php
	...
	<div class="wc-order-data-row wc-order-add-item wc-order-data-row-toggle">
			<span
				class="description"><?php esc_html_e( 'This subscription is not editable.', 'tdv-woocommerce-subscription' ); ?></span>
	</div>
