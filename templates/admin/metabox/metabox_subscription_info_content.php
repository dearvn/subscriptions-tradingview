...
$billing_fields  = tws_get_order_fields_to_edit( 'billing' );
$shipping_fields = tws_get_order_fields_to_edit( 'shipping' );
...
<div id="subscription-data" class="panel">
	...
	<h2>
		...
		printf( esc_html_x( 'Subscription %s details', 'Placeholder: subscription id', 'tdv-woocommerce-subscription' ), esc_html( $subscription->get_number() ) );
		?>
		<span
	...
	<p class="subscription_number"> <?php echo TWS_Subscription_Helper()->get_formatted_recurring( $subscription, '', true, true ); // phpcs:ignore ?> </p>

	<div class="subscription_data_column_container">
		<div class="subscription_data_column">
			<h3><?php esc_html_e( 'General Details', 'tdv-woocommerce-subscription' ); ?></h3>

			<div class="subscription-date-info">
				<?php if ( ! empty( $subscription->start_date ) ) : ?>
					<span class="subscription-date-info-element">
					<label><?php esc_html_e( 'Started date:', 'tdv-woocommerce-subscription' ); ?></label>
				...
				<?php if ( ! empty( $subscription->expired_date ) ) : ?>
					<span class="subscription-date-info-element">
					<label><?php esc_html_e( 'Expired date:', 'tdv-woocommerce-subscription' ); ?></label>
				...
				<?php if ( ! empty( $subscription->payment_due_date ) ) : ?>
					<span class="subscription-date-info-element">
					<label><?php esc_html_e( 'Payment due date:', 'tdv-woocommerce-subscription' ); ?></label>
				...
				<?php if ( ! empty( $subscription->cancelled_date ) ) : ?>
					<span class="subscription-date-info-element">
						<label><?php esc_html_e( 'Cancelled date:', 'tdv-woocommerce-subscription' ); ?></label>
				...
				<?php if ( ! empty( $subscription->end_date ) ) : ?>
					<span class="subscription-date-info-element">
						<label><?php esc_html_e( 'End date:', 'tdv-woocommerce-subscription' ); ?></label>
			...
			<p class="form-field form-field-wide">
				<label><?php esc_html_e( 'Payment Method:', 'tdv-woocommerce-subscription' ); ?></label>
				<?php echo esc_html( $subscription->payment_method_title ); ?>
			</p>
			<?php if ( ! empty( $subscription->transaction_id ) ) : ?>
				<p class="form-field form-field-wide">
					<label><?php esc_html_e( 'Transaction ID:', 'tdv-woocommerce-subscription' ); ?></label>
					<?php echo esc_html( $subscription->transaction_id ); ?>
				</p>
			<?php endif ?>
			<p class="form-field form-field-wide tws-customer">
				<label><?php esc_html_e( 'Customer:', 'tdv-woocommerce-subscription' ); ?></label>
				<?php
				$user_string = '';
		...
		<div class="subscription_data_column">
			<h3>
				<?php esc_html_e( 'Billing', 'tdv-woocommerce-subscription' ); ?>
			</h3>
			...
			<div class="address">
				...
				if ( $formatted_address ) {
					...
					echo '<p class="none_set"><strong>' . esc_html__( 'Address:', 'tdv-woocommerce-subscription' ) . '</strong> ' . esc_html__( 'No billing address set.', 'tdv-woocommerce-subscriptions' ) . '</p>';
				}
			...
			<?php
			do_action( 'tws_admin_subscription_data_after_billing_address', $subscription )
			?>
		...
		<div class="subscription_data_column">
			<h3>
				<?php esc_html_e( 'Shipping', 'tdv-woocommerce-subscription' ); ?>
			...
			<div class="address">
				...
				if ( $formatted_address ) {
					...
					echo '<p class="none_set"><strong>' . __( 'Address:', 'tdv-woocommerce-subscription' ) . '</strong> ' . __( 'No shipping address set.', 'tdv-woocommerce-subscriptions' ) . '</p>'; // phpcs:ignore
				}
			...
			<?php
			do_action( 'tws_admin_subscription_data_after_shipping_address', $subscription )
			?>
		</div>
	</div>
	<div class="clear"></div>
