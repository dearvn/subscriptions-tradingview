...
(function( $ ) {
	...
	var wps_subscripiton_migration_success = function() {
		...
		if ( tdv_admin_param.pending_product_count != 0 && tdv_admin_param.pending_orders_count != 0 && tdv_admin_param.pending_subscription_count != 0 ) {
			jQuery( "#wps_tdv_migration-button" ).click();
			jQuery( "#wps_tdv_migration-button" ).show();
		}else{
			jQuery( "#wps_tdv_migration-button" ).hide();
